...
$c_LMyMain$.prototype = new $h_O();
$c_LMyMain$.prototype.constructor = $c_LMyMain$;
/** @constructor */
function $h_LMyMain$() {
  /*<skip>*/
}
$h_LMyMain$.prototype = $c_LMyMain$.prototype;
$c_LMyMain$.prototype.init___ = (function() {
  return this
});
$c_LMyMain$.prototype.append__V = (function() {
  var name = (0, $m_Lorg_querki_jquery_package$().$$$1)("#name").val();
  (0, $m_Lorg_querki_jquery_package$().$$$1)("#p1").html(("Hi " + name))
});
$c_LMyMain$.prototype.main__V = (function() {
  /*<skip>*/
});
$c_LMyMain$.prototype.$$js$exported$meth$main__O = (function() {
  return (void 0)
});
$c_LMyMain$.prototype.main = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_LMyMain$ = new $TypeData().initClass({
  LMyMain$: 0
}, false, "MyMain$", {
  LMyMain$: 1,
  O: 1,
...
$c_LMyMain$.prototype.$classData = $d_LMyMain$;
var $n_LMyMain$ = (void 0);
function $m_LMyMain$() {
  if ((!$n_LMyMain$)) {
    $n_LMyMain$ = new $c_LMyMain$().init___()
  };
  return $n_LMyMain$
}
/** @constructor */
...
//# sourceMappingURL=tesingwithscalajs-fastopt.js.map
